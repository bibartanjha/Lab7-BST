...
int main() {
    ...
    cout << "Is item in Tree Test" << endl;
    s = "bib";
    bool inTree = bst.isItemInTree(s);
    cout << inTree << endl;
    s = "series";
    inTree = bst.isItemInTree(s);
    if (inTree == true)
        cout << "true" << endl;
    cout << endl;
    ...
    cout << "number of nodes in tree before make empty is " << bst.countNodes() << endl;
    bst.makeEmpty();
